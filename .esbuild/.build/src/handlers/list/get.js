...
// src/controllers/list/get.ts
var GetListController = class {
...
// src/services/list/get.ts
var GetListService = class {
  ...
  formatData(listData, tasksData) {
    ...
    return {
      ...
      tasks: ((_a = tasksData == null ? void 0 : tasksData.Items) == null ? void 0 : _a.length) > 0 ? tasksData.Items.map((task) => ({
        id: task.id,
...
// src/factories/controllers/list/get.ts
var makeGetListController = () => {

...
// src/constraints/list/create.ts
var createListConstraint = () => {
  return {
    "name": {
      "presence": {
        "allowEmpty": false
...
// src/controllers/list/create.ts
var CreateListController = class {
...
// src/services/list/create.ts
var CreateListService = class {
...
// src/factories/controllers/list/create.ts
var makeCreateListController = () => {
